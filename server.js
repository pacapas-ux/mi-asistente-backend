...
import fetch from "node-fetch"; // ✅ IMPORTACIÓN CORRECTA
  ...
  try {
    ...
    const faqs = {
      ...
      "quién es pepe gutiérrez":
        "Pepe Gutiérrez es un reconocido experto en administración de fincas, conferenciante y formador. Más información en https://www.pepegutierrez.guru",
    ...
    // 🧠 Si no es una FAQ → respuesta en tiempo real usando OpenRouter
      ...
      messages: [
        {
          role: "system",
          content:
            "Eres un asistente virtual que responde con información actualizada y en tiempo real, igual que ChatGPT, usando OpenRouter.",
        },
    ...
    const reply =
      ...
      "⚠️ No se recibió respuesta del asistente.";
